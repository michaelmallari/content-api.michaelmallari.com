// Generated on 2015-06-12 using generator-php 0.4.0
'use strict';
...
module.exports = function (grunt) {
	...
	var yeomanConfig = {
		app: 'app',
		dist: 'dist',
		siteURL: 'content-api.michaelmallari.com',
		devURL: 'localhost',
		devPort: 80
	};
	...
	grunt.initConfig({
		...
		processhtml: {
			dist: {
				files: {
					'<%= yeoman.dist %>/inc/tail.php': ['<%= yeoman.dist %>/inc/tail.php']
				}
			}
		},
		...
		inlinelint: {
			all: [
				'<%= yeoman.app %>/**/*{.html,.php}',
				'!<%= yeoman.app %>/bower_components/**/*{.html,.php}'
			]
		},
